...
export function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0b1220] text-slate-100 flex flex-col h-full shrink-0 border-r border-slate-800/80 transition-transform duration-200 lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-5 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-cyan-700 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-950/50">
            ...
            <div className="overflow-hidden">
              ...
              <span className="text-[10px] text-cyan-300 font-semibold tracking-wider uppercase flex items-center gap-1 mt-0.5">
        ...
        <div className="p-3 border-t border-slate-800/80 bg-slate-950/60 space-y-2.5">
          <div className="px-2 py-1 flex items-center justify-between">
            ...
            <button
              ...
              className="text-cyan-300 hover:text-cyan-200 text-[10px] font-bold flex items-center gap-1 uppercase transition-colors px-2 py-1 hover:bg-slate-800 rounded"
